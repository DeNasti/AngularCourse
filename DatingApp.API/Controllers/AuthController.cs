...
namespace DatingApp.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Login(UserForLoginDto userForLoginDto)
        {
            ...
            //i prepare username and userID to be inserted into the token
            var claims = new[]
            {
            ...
            //i "sign" the token with what is in the appsetting (also called token)
            ...
            //i send it back with an ok message
            return Ok(new {
